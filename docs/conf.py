...
# -*- coding: utf-8 -*-
#
# tayrakit documentation build configuration file, created by
...
try:
    release = pkg_resources.get_distribution('tayrakit').version
except ImportError:
...
latex_documents = [
  ('index', 'tayrakit.tex', 'tayrakit Documentation',
...
man_pages = [
    ('index', 'tayrakit', 'Tayrakit Documentation',
...
texinfo_documents = [
  ('index', 'tayrakit', 'Tayrakit Documentation',
   'Pratap Chakravarthy', 'tayrakit', 'Widget toolkit using Tayra',
   'Miscellaneous'),
]
